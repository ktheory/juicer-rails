...
juicer-rails is a Rails plugin for juicer, a tool for minifying CSS and JavaScript assets (http://github.com/cjohansen/juicer).
...
Juicer can also embed images in your stylesheets. Of course, this doesn't work in IE. Embedding is disabled by default, but you can turn it on in the rails initializer:
  ...
  Juicer::ActionViewHelper.use_embedded_images = true
